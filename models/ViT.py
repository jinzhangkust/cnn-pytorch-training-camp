...
@register_model()
def vit_b_16_diy(*, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
@register_model()
def vit_b_32_diy(*, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
@register_model()
def vit_l_16_diy(*, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
